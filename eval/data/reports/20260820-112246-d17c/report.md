# Benchmark Report — 20260820-112246-d17c
...
| --- | --- | --- | --- | --- | --- | --- |
| T1-001 | TASK_1 | 5.0 | 6.5 | +1.5 | 0.007s | 0.0 |
| T1-002 | TASK_1 | 7.0 | 6.5 | -0.5 | 0.002s | 0.0 |
| T1-003 | TASK_1 | 7.5 | 6.5 | -1.0 | 0.002s | 0.0 |
| T1-004 | TASK_1 | 8.0 | 6.5 | -1.5 | 0.002s | 0.0 |
| T1-005 | TASK_1 | 4.5 | 6.5 | +2.0 | 0.001s | 0.0 |
| T2-001 | TASK_2 | 5.5 | 6.5 | +1.0 | 0.002s | 0.0 |
| T2-002 | TASK_2 | 6.5 | 6.5 | +0.0 | 0.002s | 0.0 |
| T2-003 | TASK_2 | 7.5 | 6.5 | -1.0 | 0.003s | 0.0 |
| T2-004 | TASK_2 | 8.0 | 6.5 | -1.5 | 0.002s | 0.0 |
| T2-005 | TASK_2 | 4.5 | 6.5 | +2.0 | 0.001s | 0.0 |
