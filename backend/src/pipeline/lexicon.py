...
Ported unchanged from the IE AI Evaluator's `src/pipeline/lexicon.py`.
"""
...
COHESIVE_DEVICES: tuple[str, ...] = (
    ...
    "on the one hand", "in other words", "that is to say", "for this reason",
    "despite", "in spite of", "although", "even though", "whereas", "while",
)
